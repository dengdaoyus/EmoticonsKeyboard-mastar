...
import com.emoticonskeyboard.userdef.MousnsChatActivity;
...
//    }
    ...
    @OnClick(R.id.btn_chat_mousns) void btn_chat_mousns() {
        startActivity(new Intent(MainActivity.this, MousnsChatActivity.class));
    }
