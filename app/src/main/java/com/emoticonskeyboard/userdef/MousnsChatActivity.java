...
import com.emoticonskeyboard.common.Constants;
import com.emoticonskeyboard.common.SimpleCommonUtils;
import com.emoticonskeyboard.common.adapter.ChattingListAdapter;
import com.emoticonskeyboard.common.data.ImMsgBean;
...
public class MousnsChatActivity extends AppCompatActivity implements FuncLayout.OnFuncKeyBoardListener {

    @Bind(R.id.toolbar) Toolbar toolbar;
    @Bind(R.id.lv_chat) ListView lvChat;
    @Bind(R.id.ek_bar) MousnsEmoticonsKeyBoard ekBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_chat_mousns);
    ...
    private void initEmoticonsKeyBoardBar() {
        ...
        ekBar.addFuncView(new MousnsVoice(this));
        ...
        ekBar.getEmoticonsToolBarView().addFixedToolItemView(false, R.mipmap.icon_add, null, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MousnsChatActivity.this, "ADD", Toast.LENGTH_SHORT).show();
            }
        });
        ekBar.getEmoticonsToolBarView().addToolItemView(R.mipmap.icon_setting, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MousnsChatActivity.this, "SETTING", Toast.LENGTH_SHORT).show();
            }
        });
    }
