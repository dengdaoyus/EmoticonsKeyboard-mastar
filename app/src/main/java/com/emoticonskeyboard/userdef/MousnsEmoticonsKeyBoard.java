...
public class MousnsEmoticonsKeyBoard extends XhsEmoticonsKeyBoard {
    ...
    public MousnsEmoticonsKeyBoard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    protected void inflateKeyboardBar(){
        mInflater.inflate(R.layout.view_keyboard_mousns, this);
    }
...
//            }
//        } else
            if (i == com.keyboard.view.R.id.btn_face) {
